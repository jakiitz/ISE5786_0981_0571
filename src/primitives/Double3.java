...
public record Double3(double _d1, double _d2, double _d3) {
   ...
   /**
    * Constructor to initialize primitives.Double3 based object the same number values
    ...
    * @return     a new {@code primitives.Double3} containing the component-wise sum
    */
    ...
    * @return     a new {@code primitives.Double3} containing the component-wise difference
    */
    ...
    * @return     a new {@code primitives.Double3} containing the scaled values
    */
    ...
    * @return     a new {@code primitives.Double3} containing the reduced values
    */
    ...
    * @return     a new {@code primitives.Double3} containing the component-wise product
    */
   ...
   /**
    * Checks whether this triad is not lower than another triad component-wise.
    * @param  other the triad to compare with
    * @return       {@code true} if at least one component of this triad is greater
    *               than or equal to the corresponding component in {@code other}
    */
