...
class LightsTests {
   ...
   void testSphereMultipleLights() {
      ...
      _scene1.lights.add(
         new DirectionalLight(new Color(200, 120, 80), new Vector(1, 1, -1))
      );

      _scene1.lights.add(
         new PointLight(new Color(250, 160, 80), new Point(-50, -50, 25))
            .setKl(0.001)
            .setKq(0.0002)
      );

      _scene1.lights.add(
         new SpotLight(new Color(450, 300, 120), new Point(60, 40, 40), new Vector(-1, -1, -1))
            .setKl(0.001)
            .setKq(0.0001)
            .setNarrowBeam(10)
      );
   ...
   void testTrianglesMultipleLights() {
      ...
      _scene2.lights.add(
         new DirectionalLight(new Color(180, 100, 80), new Vector(-2, -2, -2))
      );

      _scene2.lights.add(
         new PointLight(new Color(350, 220, 120), new Point(30, 10, -100))
            .setKl(0.001)
            .setKq(0.0002)
      );

      _scene2.lights.add(
         new SpotLight(new Color(500, 300, 150), new Point(-60, -40, 80), new Vector(1, 1, -2))
            .setKl(0.001)
            .setKq(0.0001)
            .setNarrowBeam(8)
      );
