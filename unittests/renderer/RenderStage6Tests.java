...
class RenderStage6Tests {
    ...
    void testRenderAmbientColor() {
        ...
        scene.geometries //
                .add(// center
                        new Sphere(O, RADIUS).setMaterial(new Material().setKa(0.4)),
                        // up left
                        new Triangle(P_LM, P_MT, P_LT).setMaterial(new Material().setKa(new Double3(0, 0.8, 0))),
                        // down left
                        new Triangle(P_LM, P_MB, P_LB).setMaterial(new Material().setKa(new Double3(0.8, 0, 0))),
                        // down right
                        new Triangle(P_RM, P_MB, P_RB).setMaterial(new Material().setKa(new Double3(0, 0, 0.8)))
                );
